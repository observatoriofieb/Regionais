...
fig.write_html('proposta_nova_regional.html', include_plotlyjs='cdn')

regionais_senai_sesi[['SENAI', 'Municipio', 'SESI', 'FIEB', 'IEL', 'Regionais Pós Mudança', 'Mudou Regional']].to_excel('proposta_regionais_nova_regional.xlsx', index=False)